 ...
 */
final class Version20200909181034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase_order ADD total INT NOT NULL, ADD created_at DATETIME NOT NULL, DROP date_order');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase_order ADD date_order DATE DEFAULT NULL, DROP total, DROP created_at');
    }
}
